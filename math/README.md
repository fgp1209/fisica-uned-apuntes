...
- Corregidos los botones HTML: ahora usan LaTeX real, no barras escapadas de JavaScript.
- El botón `math kbd` usa directamente `window.mathVirtualKeyboard.show()/hide()`.
- Se normalizan líneas antiguas guardadas con `\\frac` o comandos escapados de más.
